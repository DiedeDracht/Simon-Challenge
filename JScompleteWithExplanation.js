...
// If the if conditions are not satisfied,
// i.e. user presses wrong colors
// compared to game's color, in short patterns do not tally,
// then the game will end i.e. else statements
// will be executed.
    } else {
      playSound("wrong");
